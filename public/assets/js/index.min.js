...
(() => {
          ...
          void 0 !== n &&
            ...
            (w(t[i]) && w(a[i])
              ? a[i].__swiper__
                ...
                : b(t[i], a[i])
              : !w(t[i]) && w(a[i])
              ? ((t[i] = {}), a[i].__swiper__ ? (t[i] = a[i]) : b(t[i], a[i]))
              : (t[i] = a[i]));
        }
      }
    }
  ...
  function G(e) {
    ...
    if (c > i.longSwipesMs) {
      ...
      "next" === t.swipeDirection &&
        (f >= i.longSwipesRatio ? t.slideTo(u + v) : t.slideTo(u)),
        "prev" === t.swipeDirection &&
          (f > 1 - i.longSwipesRatio ? t.slideTo(u + v) : t.slideTo(u));
    } else {
  ...
  function ie(t) {
    for (var s = 1; s < arguments.length; s++) {
      ...
      s % 2
        ? se(Object(i), !0).forEach(function (s) {
            e(t, s, i[s]);
          })
        : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(i))
        : se(Object(i)).forEach(function (e) {
  ...
  function ae(e) {
    var t =
      ...
      n =
        parseFloat(window.getComputedStyle(i).marginLeft) +
        parseFloat(window.getComputedStyle(i).paddingLeft);
    s &&
      ("both" === t
        ? ((s.style.paddingLeft = "".concat(n, "px")),
          (s.style.paddingRight = "".concat(n, "px")))
        : "left" === t
        ? (s.style.paddingLeft = "".concat(n, "px"))
        : "right" === t && (s.style.paddingRight = "".concat(n, "px")));
  }
  Q.use([
    function ({ swiper: e, extendParams: t, on: s, emit: i }) {
      function n(t) {
      ...
      t({
        ...
        s("click", (t, s) => {
          const { $nextEl: n, $prevEl: a } = e.navigation,
            r = s.target;
          if (e.params.navigation.hideOnClick && !f(r).is(a) && !f(r).is(n)) {
            if (
              e.pagination &&
              e.params.pagination &&
    ...
    function ({ swiper: e, extendParams: t, on: s, emit: i }) {
      ...
      function d() {
        ...
        if (
          ("fraction" === s.type &&
            (d.find(ee(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
            d.find(ee(s.totalClass)).text(s.formatFractionTotal(p))),
          "progressbar" === s.type)
        ) {
          let t;
          ...
          "horizontal" === t ? (n = i) : (a = i),
            d
              .find(ee(s.progressbarFillClass))
      ...
      function c() {
        ...
        if ("bullets" === t.type) {
          ...
          n.html(a), (e.pagination.bullets = n.find(ee(t.bulletClass)));
        }
        "fraction" === t.type &&
          ((a = t.renderFraction
      ...
      function p() {
        ...
        0 !== s.length &&
          ...
          t.clickable &&
            s.on("click", ee(t.bulletClass), function (t) {
              t.preventDefault();
      ...
      s("init", () => {
        ...
        s("click", (t, s) => {
          ...
          if (
            ...
            a.length > 0 &&
            !f(n).hasClass(e.params.pagination.bulletClass)
          ) {
            if (
              e.navigation &&
    ...
    function ({ swiper: e, extendParams: t, on: s }) {
      ...
      function a() {
        ...
        if (
          ((n = t.params.loop
            ? parseInt(f(t.clickedSlide).attr("data-swiper-slide-index"), 10)
            : s),
          e.params.loop)
        ) {
          let t = e.activeIndex;
    ...
    e.forEach(function (e, i) {
      e.addEventListener("click", function (e) {
        ...
        e.target.classList.contains("collapsed")
          ? t[i].classList.remove("transform")
          : t[i].classList.add("transform");
      }),
        0 !== s.length &&
          s[i].addEventListener("shown.bs.collapse", function (e) {
            var t = parseFloat(window.getComputedStyle(s[i]).height);
            window.pageYOffset > 500 &&
              window.scrollTo(0, window.pageYOffset - (t - 200));
          });
    });
  };
  function le() {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    window.addEventListener("resize", le),
      ...
      (e = ".hero-pagination"),
      document
        .querySelectorAll("".concat(e, " .swiper-pagination-bullet"))
        .forEach(function (e, t) {
          e.textContent = t < 10 ? "0".concat(t + 1) : "".concat(t + 1);
        }),
      ne(".reviews_slider", {
        slidesPerView: 1,
        loop: !0,
      ...
      ne(".partners_list", {
        ...
        breakpoints: {
          ...
          768: { slidesPerView: 3 },
          992: { slidesPerView: 4 },
          1200: { slidesPerView: 5, autoplay: !1 },
        },
      }),
      ne(".popular_slider", {
        slidesPerView: 1,
