...
class Header extends HTMLElement {
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
       ...
       <a href="../index.html" class="logo me-auto"><img src="../public/asset/img/logo.webp" alt="" class="img-fluid"></a>
            ...
            <ul>
              <li class="dropdown"><a href="#"><span>Online</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  ...
                  <li><a href="../program/basic-class.html">Basic Class <span class="badge rounded-pill text-bg-success">Best
                        Buy</span></a></li>
        ...
        <div class="container-fluid">
          <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            <div class="offcanvas-header">
              <a href="../index.html">
                <img src="../public/asset/img/logo.webp" class="offcanvas-title" id="offcanvasNavbarLabel"/>
              </a>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row justify-content-between">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3><img src="../public/asset/img/white-logo.webp" class="footer-logo" alt="Kelas Public Speaking Jogja" /></h3>
            <p>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <div class="">
              <div class="footer-recent-post align-items-center">
                ...
                <ul>
                  <li class="clearfix">
                    <img src="../public/asset/img/ig/1.jpg" alt="" class="rounded ig-post float-left" style="margin-right: 10px;width: 70px;height: 70px; border-radius: 10px;">
                  ...
                  <hr/>
                  <li class="clearfix">
                    <img src="../public/asset/img/ig/2.jpg" alt="" class="rounded ig-post float-left" style="margin-right: 10px;width: 70px;height: 70px; border-radius: 10px;">
                    <div class="post float-left">
                  ...
                  <hr/>
                  <li class="clearfix">
                    <img src="../public/asset/img/ig/3.jpg" alt="" class="rounded ig-post float-left" style="margin-right: 10px;width: 70px;height: 70px; border-radius: 10px;">
                    <div class="post float-left">
                  ...
                  <hr/>
                  <li class="clearfix">
                    <img src="../public/asset/img/ig/4.jpg" alt="" class="rounded ig-post float-left" style="margin-right: 10px;width: 70px;height: 70px; border-radius: 10px;">
                    <div class="post float-left">
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <img src="../public/asset/img/bank.webp" style="width:100%;"/>
            <br><br>
            <p><i class="bx bx-chevron-down"></i> E-Wallet</p>
            <img src="../public/asset/img/wallet.webp" style="width:100%;"/>

            <ul class="list-group border-warning" style="background: transparent;">
              <li class="list-group-item">
                <b>Telah Terdaftar Oleh</b><br>
                <img src="../public/asset/img/ham.webp" class="" /><br>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="social-links text-center text-md-right pt-3 pt-md-0">
        ...
        <a href="https://link.dialogika.co/facebook" class="facebook"><i class="bi bi-facebook"></i></a>
        <a href="https://link.dialogika.co/instagram" class="instagram"><i class="bi bi-instagram"></i></a>
        <a href="https://wa.link/gszino" class="google-plus"><i
