...
interface JoditRegularEditorProps {
  value?: string;
...
const JoditRegularEditor = ({ editorContent, setEditorContent }: JoditRegularEditorProps) => {
    useEffect(() => {
    ...
    useEffect(() => {
      localStorage.setItem("joditEditorContent", editorContent)
    ...
    const joditConfig = useMemo(
      () => ({
        ...
        extraButtons: [
          {
            name: "pexelsImage",
            iconURL: "https://dialogika.co/blog/assets/img/icons/svg/pexels.svg",
            exec: (editor: any) => {
              const overlay = document.createElement("div");
              Object.assign(overlay.style, {
                position: "fixed",
